...
## Information
> xyuziMd adalah bot yang awalnya memakai base dari [Chikabot](https://github.com/rashidsiregar28/chikabot/blob/main/README.md), sekarang pindah base [Hisoka-Morou](https://github.com/DikaArdnt/Hisoka-Morou). Alphabot-Md is a bot whatsapp using a Baileys library.
...
global.packname = '©Xyuzi' //sticker wm
global.author = 'Di Buat Oleh Xyuzi' //sticker wm
